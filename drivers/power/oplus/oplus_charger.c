...
int oplus_chg_parse_charger_dt(struct oplus_chg_chip *chip)
{
	...
	rc = of_property_read_u32(node, "qcom,chg_sw_timer_margin", &chip->chg_sw_timer_margin);
	if(rc) {
		chip->chg_sw_timer_margin = 0;
	}
